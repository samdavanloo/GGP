function [mappedX] = isomap2(X, no_dims, k)
% was function [mappedX, mapping] = isomap(X, no_dims, k) but we do not sue
% the mapping, and always find the geodesics on ALL elements, not only on
